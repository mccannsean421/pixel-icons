const IconList = [
    { 
        ...
        svg: `<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M34 8H24V13H14V23H9V33V43V53H14V63H24V68H33H34H43H53V63H62V73H67V78H72V83H77V88H82V93H92V83H87V78H82V73H77V68H72V63H62V53H67V43V33V23H62V13H54V8H44H34ZM19 23V33V43V53H24V58H33H34H43H52V53H57V43V33V23H52V18H44H34H24V23H19Z" fill="#D9D9D9"/>
        </svg>` 
    },
    {
        name: 'heart',
